import { config } from "./package_2e304e0d48d9a7dc8806856fe671b79f644d7881/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_2e304e0d48d9a7dc8806856fe671b79f644d7881').then(async function (cache) {
